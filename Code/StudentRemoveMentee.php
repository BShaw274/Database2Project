...
$sql = "SELECT meet_id
FROM enroll
WHERE meet_id = " . $meetingId. " AND mentee_id = " . $studentId . ";";
...
if ($MenteeRadioVal == 'single'){
    ...
    $sql = "DELETE FROM enroll  WHERE  meet_id = " .$meetingId ." AND mentee_id = " . $studentId . ";";
    $result = mysqli_query($dbConnection , $sql);
    if ($result) {
    ...
    if (mysqli_num_rows($result)) {
        ...
        while($row2 = mysqli_fetch_assoc($result2)) {
            ...
            $sql3 = "DELETE FROM enroll  WHERE  meet_id = " .$row2["meet_id"] ." AND mentee_id = " . $studentId . ";";
...
$query = 'SELECT mentee_id FROM enroll WHERE mentee_id= ' . $studentId;
